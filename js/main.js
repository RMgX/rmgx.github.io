(function($){
	$(document).ready(function(){
		...
		$('#paginateblogs').easyPaginate({
	    	paginateElement: 'article',
	    	elementsPerPage: 5,
	    	effect: 'climb'
		});
		
		// Code to avoid showing empty images in case they are not found ( broken image handling ) 
		$("img").error(function(){
	        $(this).hide();
		});
	...
	if(jQuery.isFunction(jQuery.fn.isotope)){
		jQuery('#easyPaginate.portfolio_list').isotope({

...
$.fn.easyPaginate = function (options) {
    ...
    return this.each (function (instance) {        
        ...
        var displayNav = function() {
            htmlNav = '<div class="col-lg-12 col-md-12 col-sm-12 easyPaginateNav"> <ul class="pagination pull-right mrgt-0 ">';
            
          
            if(plugin.settings.prevButton) {
                htmlNav += '<li><a href="" title="Previous" rel="" class="prev">&laquo;</a></li>';
            }
            ...
            if(plugin.settings.nextButton) {
                htmlNav += '<li><a href="" title="Next" rel="" class="next">&raquo;</a></li>';
            }
